...
public class ViewListProjectController implements Initializable, ApplicationListener<StageReadyEvent> {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        initSizeForComponents();
        initStyleForComponents();
        initValueDefaultForComponents();
    }

    private void initSizeForComponents(){
    ...
    private void initStyleForComponents(){
    ...
    private void initValueDefaultForComponents(){
...
//        projectAdapter.retrieveProjectWithCriteriaAndStatusSpecified(tfSearchValue,status,20, 0);
    ...
    @FXML
    public void onLbBtnResetSearchClicked() {
        tfSearch.clear();
        cbStatus.getSelectionModel().select(-1);
        fillDataProjectToTable(null, null);
    }

    private Alert createConfirmationDeleteProjectDialog(){
